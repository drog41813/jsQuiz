  ...
  {
    question: "question 3", 
    option: ["Wrong", "Wrong", "Wrong", "Right"],
    answer: 3, 
  },
  {
    question: "question 4",
    option: ["Wrong", "Wrong", "Right", "Wrong"],
    answer: 2,
  },
  ];
  ...
  function endQuiz() {
    endTime = timeleft;
    timerElement.styledisplay = "none";
    optionsElement.style.display = "none";
    textboxElement.style.display = "block";
    submitElement.style.display = "block";
    questionElement.textContent = "Your score is " + score + "out of 4, with"
  };

  function saveScore() {
    var initials = textboxElement.value;
    leaderboard.push["user: " + initials, "score: " + score, "time left: "]
